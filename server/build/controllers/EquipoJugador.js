...
const createJugador = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { nombre_completo, sexo, fecha_nacimiento, id_equipo, posicion, correo, anios_experiencia, ciudad_nacimiento, peso, estatura, amonestaciones, puntos_acumulados, nombreClub, categoria, pasatiempos, musica_favorita, apodo, redes_sociales // Nuevo campo
     } = req.body;
    const file = req.file;
    ...
    try {
        ...
        const result = yield database_1.default.query(`INSERT INTO jugador 
